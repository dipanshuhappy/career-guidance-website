...
function ActionBar() {
    return (
        <div className=' bg-slate-200'>
            <div className='w-2/3 h-full bg-white flex items-center mx-auto justify-between px-4'>
                <button className="btn md:m-1/3  sm:btn-sm md:btn-md lg:btn-lg text-white gap-12 border h-full bg-yellow-500 border-none">
                    Categories
                    <ThreeDotSvg />
                </button>
